...
const Login = () => {
    ...
    return (
        <div className='my-10'>
            <form onSubmit={handleLogin} className='w-2/5 shadow-2xl mx-auto p-10 ps-40 space-y-3 bg-orange-50'>
                ...
                <input type="submit" value="Login" className='border bg-green-300 hover:bg-green-700 p-2 rounded-lg w-52 mt-1' /> <br />
            ...
            <Link to='/register' className='hover:text-blue-500 mt-5'>Don't have an account? Register</Link>
            </form>
