...
const Footer = () => {
    return (
        <div className='bg-black opacity-80 px-20 py-5'>
            ...
            <div className='text-center space-y-5'>
                ...
                <input type="text" name="" id="" placeholder='Your message' className='p-2'/> <br />
                <input type="email" name="" id="" placeholder='Your email' className='p-2'/>
            </div>
